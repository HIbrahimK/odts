            ...
            <form method="POST" action="{{route('users.store')}}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="schools" class="form-label">Okulu</label>
                            <select class="form-control select2"  id="select2" data-placeholder="Okul Seçin" name="schools[]">
                                @foreach ($schools as $school)
                                    <option value="{{$school->id}}">{{ucfirst($school->okul_adi)}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
